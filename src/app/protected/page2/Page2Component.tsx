...
export default function Page2({permitido}:Props){
    ...
    return(
            <span>
                    <nav>
                        <button className="nav_btn" onClick={()=>router.push("/protected/page1")}>Voltar</button>
                        <button className="nav_btn" onClick={()=>router.push("/protected/page3")}>Ir para página 3</button>
                    </nav>
                <form>
        ...
        return(<div><p>Faça login para visualizar essa página</p></div>)
}